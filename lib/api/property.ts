...
export const propertyApi = {
    ...
    search: (params?: { type?: string; priceMin?: number; priceMax?: number }) => client.get<{ properties: Property[] }>('/property/all', { params }),
    getApprovedProperties: (params?: { type?: string; priceMin?: number; priceMax?: number; minArea?: number; maxArea?: number }) => client.get<{ properties: Property[]; total: number }>('/property/approved', { params }),
