...
export default function AdminNotificationsPage() {
  ...
  useEffect(() => {
    ...
    // const userId = "68a84b87a3a233957506f479"; 
    // const model = "Property"; 
    // const role = RoleEnum.Admin; 

    //   // fetchNotificationbyRoleAndUserIDAndModel(userId, model, role);
    GetAllNotifcations();
  }, []);
  ...
  // const fetchNotificationbyRoleAndUserIDAndModel = async (id: string, model: string, role: RoleEnum) => {
  //   try {
  //     const res = await NotificationApi.getNotificationsByUserIDAndModelAndRole(id, model, role);
  //     console.log("Notification Response Data", res); 
  //     setA(res); // ✅ res is Notification[]
  //   } catch (error) {
  //     toast.error("Failed to fetch pending requests");
  //   }
  // };
                ...
                <TableBody>
                  {AllNotifications.map((notification) => (
                    <TableRow
                      ...
                      className={`transition-colors ${notification.relatedModel === "Property"
                        ? "hover:bg-green-50"
                        : "hover:bg-blue-50"
                        }`}
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          <Avatar className="w-10 h-10">
                            ...
                            <AvatarFallback
                              className={`text-white ${notification.relatedModel === "Property"
                                ? "bg-gradient-to-r from-green-500 to-emerald-500"
                                : "bg-gradient-to-r from-blue-500 to-purple-500"
                                }`}
                            >
                              {notification.userId.slice(0, 2).toUpperCase()}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                            <p className="font-semibold text-gray-900">{notification.userId}</p>
                            <p className="text-sm text-gray-500">Model: {notification.relatedModel}</p>
                          </div>
                        </div>
                      </TableCell>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          <Button
                            ...
                            className={`hover:border-green-300 hover:text-green-600 ${notification.relatedModel === "Property"
                              ? "hover:bg-green-50"
                              : "hover:bg-blue-50"
                              }`}
                          >
                  ...
                  propertyNotifications.map((notification) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        {/* Header */}
                        <div className="flex items-center justify-between">
                          <h4 className="font-semibold text-gray-900">{notification.userId}</h4>
                          <div className="flex items-center space-x-2">
